...
# --- SIDEBAR (CAMBIO DE MONEDA SIN LAG) ---
...
# Monto fijo de 10 dólares por trade
monto_trade = 10.0
st.sidebar.write(f"**Monto por Trade:** ${monto_trade}")
...
if encendido:
    ...
    if p:
        ...
        # Blindaje para evitar el AttributeError de la foto
        if not st.session_state.comprado:
            ...
            if p >= st.session_state.target_fijo:
                ...
                evento = f"⏳ HOLD (Entrada: ${st.session_state.entrada:,.2f})"

...
if bot_on:
    try:
        ...
        # --- PANEL DE MÉTRICAS (VISUALIZACIÓN DE SALDO SEGÚN MODO) ---
        c1, c2, c3 = st.columns(3)
        
        # Lógica para mostrar saldo dinámico
    ...
    st.info("👋 Bot en pausa. Selecciona Modo Demo o Real en el menú lateral.")

...
def verificar_acceso(u, p):
    try:
        ...
        # Validación real contra tu tabla de Admin / 2227
...
# --- FUNCIONES TÉCNICAS (TUYAS ORIGINALES SIN TOCAR) ---
...
# --- LOGIN (REPARADO CON GOOGLE SHEETS) ---
...
if not st.session_state.autenticado:
    ...
    # --- LÓGICA DE EJECUCIÓN (TUYA ORIGINAL) ---
